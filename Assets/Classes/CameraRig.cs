...
/// <summary>
/// Manipulates the camera so we have all players in view 
/// </summary>
public class CameraRig : MonoBehaviour {

    public float m_DampTime = 0.2f;                // Approximate time for the camera to refocus.
    public float m_ScreenEdgeBuffer = 0.1f;        // Space between the top/bottom most target and the screen edge.
